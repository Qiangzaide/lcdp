import React, { useEffect, forwardRef, createElement, createContext, useContext, useState, useCallback, useImperativeHandle, useMemo } from 'react';
import { Input, Form, Empty, Layout, Drawer, Button, Modal } from 'antd';
...
function t$1() {
  return (t$1 = Object.assign || function (t) {
...
var n$1 = e$1(/(?:Trident.*rv[ :]?11\.|msie|iemobile|Windows Phone)/i),
    o = e$1(/Edge/i),
    i = e$1(/firefox/i),
    r$1 = e$1(/safari/i) && !e$1(/chrome/i) && !e$1(/android/i),
    a = e$1(/iP(ad|od|hone)/i),
    l$1 = e$1(/chrome/i) && e$1(/android/i),
    s = {
  capture: !1,
  passive: !1
};
...
function c$1(t, e, o) {
  t.addEventListener(e, o, !n$1 && s);
}

function u(t, e, o) {
  t.removeEventListener(e, o, !n$1 && s);
}
...
function f$1(t, e, n, o) {
  if (t) {
    n = n || document;

    do {
      if (null != e && (">" === e[0] ? t.parentNode === n && d$1(t, e) : d$1(t, e)) || o && t === n) return t;
      if (t === n) break;
    } while (t = h$1(t));
  }
...
function v$1(t, e, n) {
  if (t && e) if (t.classList) t.classList[n ? "add" : "remove"](e);else {
    var o = (" " + t.className + " ").replace(g$1, " ").replace(" " + e + " ", " ");
    t.className = (o + (n ? " " + e : "")).replace(g$1, " ");
  }
}
...
function y$1(t, e, o, i, r) {
  if (t.getBoundingClientRect || t === window) {
    var a, l, s, c, u, d, h;
    if (t !== window && t !== E() ? (l = (a = t.getBoundingClientRect()).top, s = a.left, c = a.bottom, u = a.right, d = a.height, h = a.width) : (l = 0, s = 0, c = window.innerHeight, u = window.innerWidth, d = window.innerHeight, h = window.innerWidth), (e || o) && t !== window && (r = r || t.parentNode, !n$1)) do {
      if (r && r.getBoundingClientRect && ("none" !== m$1(r, "transform") || o && "static" !== m$1(r, "position"))) {
        var f = r.getBoundingClientRect();
        l -= f.top + parseInt(m$1(r, "border-top-width")), s -= f.left + parseInt(m$1(r, "border-left-width")), c = l + a.height, u = s + a.width;
        break;
      }
...
function _(t, e, n) {
  for (var o = 0, i = 0, r = t.children; i < r.length;) {
    if ("none" !== r[i].style.display && r[i] !== It.ghost && r[i] !== It.dragged && f$1(r[i], n.draggable, t, !1)) {
      if (o === e) return r[i];
      o++;
    }
...
function S(t, e) {
  for (var n = t.lastElementChild; n && (n === It.ghost || "none" === m$1(n, "display") || e && !d$1(n, e));) n = n.previousElementSibling;
...
function C(t, e) {
  ...
  for (; t = t.previousElementSibling;) "TEMPLATE" === t.nodeName.toUpperCase() || t === It.clone || e && !d$1(t, e) || n++;
...
function N(t, e) {
  return function () {
    if (!p$1) {
      var n = arguments,
          o = this;
      1 === n.length ? t.call(o, n[0]) : t.apply(o, n), p$1 = setTimeout(function () {
        p$1 = void 0;
      }, e);
    }
  };
...
function I(t, e) {
  m$1(t, "position", "absolute"), m$1(t, "top", e.top), m$1(t, "left", e.left), m$1(t, "width", e.width), m$1(t, "height", e.height);
}

function P(t) {
  m$1(t, "position", ""), m$1(t, "top", ""), m$1(t, "left", ""), m$1(t, "width", ""), m$1(t, "height", "");
}

var k$1 = "Sortable" + new Date().getTime(),
    R = [],
    X = {
  ...
  pluginEvent: function (e, n, o) {
    ...
    R.forEach(function (i) {
      n[i.pluginName] && (n[i.pluginName][r] && n[i.pluginName][r](t$1({
        sortable: n
      }, o)), n.options[i.pluginName] && n[i.pluginName][e] && n[i.pluginName][e](t$1({
        sortable: n
      }, o)));
    });
  },
...
function B(e) {
  ...
  if (i = i || r && r[k$1]) {
    ...
    !window.CustomEvent || n$1 || o ? (b = document.createEvent("Event")).initEvent(a, !0, !0) : b = new CustomEvent(a, {
      bubbles: !0,
      cancelable: !0
    ...
    var y = t$1({}, m, Y.getEventProperties(a, i));
...
var L,
    ...
    yt = a,
    Dt = o || n$1 ? "cssFloat" : "float",
    _t = Et && !l$1 && !a && "draggable" in document.createElement("div"),
    St = function () {
  if (Et) {
    if (n$1) return !1;
  ...
  var n = m$1(t),
      ...
      a = i && m$1(i),
      l = r && m$1(r),
      s = a && parseInt(a.marginLeft) + parseInt(a.marginRight) + y$1(i).width,
      c = l && parseInt(l.marginLeft) + parseInt(l.marginRight) + y$1(r).width;
...
var Nt,
  ...
  if (L) {
    var e = (i = (t = t.touches ? t.touches[0] : t).clientX, r = t.clientY, pt.some(function (t) {
      if (!S(t)) {
        var e = y$1(t),
            n = t[k$1].options.emptyInsertThreshold;
    ...
    if (e) {
      ...
      n.target = n.rootEl = e, n.preventDefault = void 0, n.stopPropagation = void 0, e[k$1]._onDragOver(n);
    }
  }
  ...
  var i, r, a;
    ...
    At = function (t) {
  L && L.parentNode[k$1]._isOutsideThisEl(t.target);
};

function It(e, n) {
  if (!e || !e.nodeType || 1 !== e.nodeType) throw "Sortable: `el` must be an HTMLElement, not " + {}.toString.call(e);
  this.el = e, this.options = n = Object.assign({}, n), e[k$1] = this;
  var o,
      i,
      r = {
    group: null,
  ...
  this.nativeDraggable = !n.forceFallback && _t, this.nativeDraggable && (this.options.touchStartThreshold = 1), n.supportPointer ? c$1(e, "pointerdown", this._onTapStart) : (c$1(e, "mousedown", this._onTapStart), c$1(e, "touchstart", this._onTapStart)), this.nativeDraggable && (c$1(e, "dragover", this), c$1(e, "dragenter", this)), pt.push(this.el), n.store && n.store.get && this.sort(n.store.get(this) || []), Object.assign(this, (i = [], {
    captureAnimationState: function () {
      i = [], this.options.animation && [].slice.call(this.el.children).forEach(function (e) {
        if ("none" !== m$1(e, "display") && void 0 !== e) {
          i.push({
            target: e,
            rect: y$1(e)
          });
          var n = t$1({}, i[i.length - 1].rect);
    ...
    animate: function (t, e, n, o) {
      if (o) {
        m$1(t, "transition", ""), m$1(t, "transform", "");
        var i = b$1(this.el),
            r = (e.left - n.left) / (i && i.a || 1),
            a = (e.top - n.top) / (i && i.d || 1);
        t.animatingX = !!r, t.animatingY = !!a, m$1(t, "transform", "translate3d(" + r + "px," + a + "px,0)"), this.forRepaintDummy = function (t) {
          return t.offsetWidth;
        }(t), m$1(t, "transition", "transform " + o + "ms" + (this.options.easing ? " " + this.options.easing : "")), m$1(t, "transform", "translate3d(0,0,0)"), "number" == typeof t.animated && clearTimeout(t.animated), t.animated = setTimeout(function () {
          m$1(t, "transition", ""), m$1(t, "transform", ""), t.animated = !1, t.animatingX = !1, t.animatingY = !1;
        }, o);
      }
    }
  }));
...
function Pt(t, e, i, r, a, l, s, c) {
  var u,
      ...
      h = t[k$1],
      f = h.options.onMove;
  return !window.CustomEvent || n$1 || o ? (u = document.createEvent("Event")).initEvent("move", !0, !0) : u = new CustomEvent("move", {
    bubbles: !0,
    cancelable: !0
  }), u.to = e, u.from = t, u.dragged = i, u.draggedRect = r, u.related = a || e, u.relatedRect = l || y$1(e), u.willInsertAfter = c, u.originalEvent = s, t.dispatchEvent(u), f && (d = f.call(h, u, s)), d;
}
...
It.prototype = {
  ...
  _onTapStart: function (t) {
    if (t.cancelable) {
      ...
      if (function (t) {
      ...
      }(n), !L && !(/mousedown|pointerdown/.test(a) && 0 !== t.button || o.disabled) && !c.isContentEditable && (this.nativeDraggable || !r$1 || !s || "SELECT" !== s.tagName.toUpperCase()) && !((s = f$1(s, o.draggable, n, !1)) && s.animated || G === s)) {
        if (V = C(s), Q = C(s, o.draggable), "function" == typeof u) {
          ...
          if (o = f$1(c, o.trim(), n, !1)) return F({
            sortable: e,
            rootEl: o,
            name: "filter",
            targetEl: s,
        ...
        o.handle && !f$1(c, o.handle, n, !1) || this._prepareDragStart(t, l, s);
      }
    }
  },
  _prepareDragStart: function (t, e, r) {
    ...
    if (r && !L && r.parentNode === s) {
      var h = y$1(r);
      if (j = s, K = (L = r).parentNode, z$1 = L.nextSibling, G = r, J = u.group, It.dragged = L, rt = (et = {
        target: L,
        clientX: (e || t).clientX,
        clientY: (e || t).clientY
        ...
        H("delayEnded", l, {
          ...
          name: "choose",
          originalEvent: t
        }), v$1(L, u.chosenClass, !0));
      }, u.ignore.split(",").forEach(function (t) {
        w$1(L, t.trim(), kt);
      }), c$1(d, "dragover", Ot), c$1(d, "mousemove", Ot), c$1(d, "touchmove", Ot), c$1(d, "mouseup", l._onDrop), c$1(d, "touchend", l._onDrop), c$1(d, "touchcancel", l._onDrop), i && this.nativeDraggable && (this.options.touchStartThreshold = 4, L.draggable = !0), H("delayStart", this, {
        evt: t
      }), !u.delay || u.delayOnTouchOnly && !e || this.nativeDraggable && (o || n$1)) a();else {
        if (It.eventCanceled) return void this._onDrop();
        c$1(d, "mouseup", l._disableDelayedDrag), c$1(d, "touchend", l._disableDelayedDrag), c$1(d, "touchcancel", l._disableDelayedDrag), c$1(d, "mousemove", l._delayedDragTouchMoveHandler), c$1(d, "touchmove", l._delayedDragTouchMoveHandler), u.supportPointer && c$1(d, "pointermove", l._delayedDragTouchMoveHandler), l._dragStartTimer = setTimeout(a, u.delay);
      }
    }
  },
  ...
  _triggerDragStart: function (t, e) {
    e = e || "touch" == t.pointerType && t, !this.nativeDraggable || e ? c$1(document, this.options.supportPointer ? "pointermove" : e ? "touchmove" : "mousemove", this._onTouchMove) : (c$1(L, "dragend", this), c$1(j, "dragstart", this._onDragStart));
  ...
  _dragStarted: function (t, e) {
    if (ht = !1, j && L) {
      H("dragStarted", this, {
        evt: e
      }), this.nativeDraggable && c$1(document, "dragover", At);
      var n = this.options;
      !t && v$1(L, n.dragClass, !1), v$1(L, n.ghostClass, !0), It.active = this, t && this._appendGhost(), F({
        sortable: this,
        name: "start",
        originalEvent: e
      });
  ...
  _emulateDragOver: function () {
    if (nt) {
      ...
      if (L.parentNode[k$1]._isOutsideThisEl(t), e) do {
        if (e[k$1] && e[k$1]._onDragOver({
          clientX: nt.clientX,
          clientY: nt.clientY,
          target: t,
          rootEl: e
  ...
  _onTouchMove: function (t) {
    if (et) {
      ...
      if (W) {
        ...
        m$1(W, "webkitTransform", d), m$1(W, "mozTransform", d), m$1(W, "msTransform", d), m$1(W, "transform", d), ot = c, it = u, nt = i;
      }
  ...
  _appendGhost: function () {
    if (!W) {
      ...
      if (yt) {
        for (dt = t; "static" === m$1(dt, "position") && "none" === m$1(dt, "transform") && dt !== document;) dt = dt.parentNode;

        dt !== document.body && dt !== document.documentElement ? (dt === document && (dt = E()), e.top += dt.scrollTop, e.left += dt.scrollLeft) : dt = E(), mt = T(dt);
      }

      v$1(W = L.cloneNode(!0), n.ghostClass, !1), v$1(W, n.fallbackClass, !0), v$1(W, n.dragClass, !0), m$1(W, "transition", ""), m$1(W, "transform", ""), m$1(W, "box-sizing", "border-box"), m$1(W, "margin", 0), m$1(W, "top", e.top), m$1(W, "left", e.left), m$1(W, "width", e.width), m$1(W, "height", e.height), m$1(W, "opacity", "0.8"), m$1(W, "position", yt ? "absolute" : "fixed"), m$1(W, "zIndex", "100000"), m$1(W, "pointerEvents", "none"), It.ghost = W, t.appendChild(W), m$1(W, "transform-origin", rt / parseInt(W.style.width) * 100 + "% " + at / parseInt(W.style.height) * 100 + "%");
    }
  },
  _onDragStart: function (t, e) {
    ...
    H("dragStart", this, {
      evt: t
    }), It.eventCanceled ? this._onDrop() : (H("setupClone", this), It.eventCanceled || ((U = A$1(L)).draggable = !1, U.style["will-change"] = "", this._hideClone(), v$1(U, this.options.chosenClass, !1), It.clone = U), n.cloneId = Yt(function () {
      H("clone", n), It.eventCanceled || (n.options.removeCloneOnHide || j.insertBefore(U, L), n._hideClone(), F({
        sortable: n,
        name: "clone"
      }));
    }), !e && v$1(L, i.dragClass, !0), e ? (ft = !0, n._loopId = setInterval(n._emulateDragOver, 50)) : (u(document, "mouseup", n._onDrop), u(document, "touchend", n._onDrop), u(document, "touchcancel", n._onDrop), o && (o.effectAllowed = "move", i.setData && i.setData.call(n, o, L)), c$1(document, "drop", n), m$1(L, "transform", "translateZ(0)")), ht = !0, n._dragStartId = Yt(n._dragStarted.bind(n, e, t)), c$1(document, "selectstart", n), lt = !0, r$1 && m$1(document.body, "user-select", "none"));
  },
  _onDragOver: function (e) {
    ...
    if (!bt) {
      if (void 0 !== e.preventDefault && e.cancelable && e.preventDefault(), l = f$1(l, s.draggable, a, !0), B("dragOver"), It.eventCanceled) return b;
      ...
      if (ft = !1, u && !s.disabled && (d ? h || (i = !j.contains(L)) : tt === this || (this.lastPutMode = J.checkPull(this, u, L, e)) && c.checkPut(this, u, L, e))) {
        if (r = "vertical" === this._getDirection(e, l), n = y$1(L), B("dragOverValid"), It.eventCanceled) return b;
        if (i) return K = j, G(), this._hideClone(), B("revert"), It.eventCanceled || (z$1 ? j.insertBefore(L, z$1) : j.appendChild(L)), U(!0);
        var w = S(a, s.draggable);

        if (!w || function (t, e, n) {
          var o = y$1(S(n.el, n.options.draggable));
          ...
          if (w === L) return U(!1);
          if (w && a === e.target && (l = w), l && (o = y$1(l)), !1 !== Pt(j, a, L, n, l, o, e, !!l)) return G(), a.appendChild(L), K = a, q(), U(!0);
          ...
          if (st !== l && (_ = o[N], gt = !1, vt = !M && s.invertSwap || x), 0 !== (E = function (t, e, n, o, i, r, a, l) {
            ...
            do {
              T = K.children[P -= E];
            } while (T && ("none" === m$1(T, "display") || T === W));
          }
          ...
          if (!1 !== Y) return 1 !== Y && -1 !== Y || (X = 1 === Y), bt = !0, setTimeout(Rt, 30), G(), X && !R ? a.appendChild(L) : l.parentNode.insertBefore(L, X ? R : l), A && O(A, 0, I - A.scrollTop), K = L.parentNode, void 0 === _ || vt || (ut = Math.abs(_ - y$1(l)[N])), q(), U(!0);
        }
    ...
    function U(t) {
      return B("dragOverCompleted", {
        insertion: t
      }), t && (d ? u._hideClone() : u._showClone(g), g !== p && (v$1(L, tt ? tt.options.ghostClass : u.options.ghostClass, !1), v$1(L, s.ghostClass, !0)), tt !== g && g !== It.active ? tt = g : g === It.active && tt && (tt = null), p === g && (g._ignoreWhileAnimating = l), g.animateAll(function () {
        B("dragOverAnimationComplete"), g._ignoreWhileAnimating = null;
      }), g !== p && (p.animateAll(), p._ignoreWhileAnimating = null)), (l === L && !L.animated || l === a && !l.animated) && (st = null), s.dragoverBubble || e.rootEl || l === document || (L.parentNode[k$1]._isOutsideThisEl(e.target), !t && Ot(e)), !s.dragoverBubble && e.stopPropagation && e.stopPropagation(), b = !0;
    }
  ...
  _nulling: function () {
    H("nulling", this), j = L = K = W = z$1 = U = G = q$1 = et = nt = lt = Z = $ = V = Q = st = ct = tt = J = It.dragged = It.ghost = It.clone = It.active = null, wt.forEach(function (t) {
      t.checked = !0;
    }), wt.length = ot = it = 0;
  },
  ...
  toArray: function () {
    for (var t, e = [], n = this.el.children, o = 0, i = n.length, r = this.options; o < i; o++) f$1(t = n[o], r.draggable, this.el, !1) && e.push(t.getAttribute(r.dataIdAttr) || Xt(t));
  ...
  sort: function (t) {
    ...
    this.toArray().forEach(function (t, o) {
      var i = n.children[o];
      f$1(i, this.options.draggable, n, !1) && (e[t] = i);
  ...
  closest: function (t, e) {
    return f$1(t, e || this.options.draggable, this.el, !1);
  },
  option: function (t, e) {
    var n = this.options;
  ...
  destroy: function () {
    H("destroy", this);
    var t = this.el;
    t[k$1] = null, u(t, "mousedown", this._onTapStart), u(t, "touchstart", this._onTapStart), u(t, "pointerdown", this._onTapStart), this.nativeDraggable && (u(t, "dragover", this), u(t, "dragenter", this)), Array.prototype.forEach.call(t.querySelectorAll("[draggable]"), function (t) {
  ...
  _hideClone: function () {
    if (!q$1) {
      ...
      m$1(U, "display", "none"), this.options.removeCloneOnHide && U.parentNode && U.parentNode.removeChild(U), q$1 = !0;
    }
  },
  _showClone: function (t) {
    if ("clone" === t.lastPutMode) {
      if (q$1) {
        ...
        L.parentNode != j || this.options.group.revertClone ? z$1 ? j.insertBefore(U, z$1) : j.appendChild(U) : j.insertBefore(U, L), this.options.group.revertClone && this.animate(L, U), m$1(U, "display", ""), q$1 = !1;
      }
    } else this._hideClone();
  }
}, Et && c$1(document, "touchmove", function (t) {
  ...
  e[0].constructor === Array && (e = e[0]), e.forEach(function (e) {
    ...
    e.utils && (It.utils = t$1({}, It.utils, e.utils)), Y.mount(e);
  });
...
var ue = N(function (t, e, n, o) {
  if (e.scroll) {
    var i,
        ...
        c = E(),
        u = !1;
    ee !== n && (ee = n, se(), i = e.scrollFn, !0 === (te = e.scroll) && (te = x$1(n, !0)));
    var d = 0,
        h = te;
    ...
    do {
      ...
      ae[d].vx == P && ae[d].vy == R && ae[d].el === f || (ae[d].el = f, ae[d].vx = P, ae[d].vy = R, clearInterval(ae[d].pid), 0 == P && 0 == R || (u = !0, ae[d].pid = setInterval(function () {
        ...
        "function" == typeof i && "continue" !== i.call(It.dragged.parentNode[k$1], n, e, t, ie, ae[this.layer].el) || O(ae[this.layer].el, n, e);
      }.bind({
        layer: d
      }), 24))), d++;
    } while (e.bubbleScroll && h !== c && (h = x$1(h, !1)));
...
It.mount(new function () {
  ...
  return t.prototype = {
    dragStarted: function (t) {
      var e = t.originalEvent;
      this.sortable.nativeDraggable ? c$1(document, "dragover", this._handleAutoScroll) : c$1(document, this.options.supportPointer ? "pointermove" : e.touches ? "touchmove" : "mousemove", this._handleFallbackAutoScroll);
    },
    ...
    drop: function () {
      this.sortable.nativeDraggable ? u(document, "dragover", this._handleAutoScroll) : (u(document, "pointermove", this._handleFallbackAutoScroll), u(document, "touchmove", this._handleFallbackAutoScroll), u(document, "mousemove", this._handleFallbackAutoScroll)), ce(), se(), clearTimeout(p$1), p$1 = void 0;
    },
    nulling: function () {
    ...
    _handleAutoScroll: function (t, e) {
      ...
      if (ie = t, e || o || n$1 || r$1) {
        ...
        !le || re && a === ne && l === oe || (re && ce(), re = setInterval(function () {
          var n = x$1(document.elementFromPoint(a, l), !0);
          n !== c && (c = n, se()), ue(t, i.options, n, e);
        }, 10), ne = a, oe = l);
      } else {
        if (!this.options.bubbleScroll || x$1(s, !0) === E()) return void se();
        ue(t, this.options, x$1(s, !1), !1);
      }
    }
  }, Object.assign(t, {
    pluginName: "scroll",
  ...
  return t.prototype = {
    ...
    dragOverValid: function (t) {
      ...
      if (t.activeSortable.options.swap) {
        ...
        if (n && n !== this.sortable.el) {
          var a = Nt;
          !1 !== (0, t.onMove)(n) ? (v$1(n, r.swapClass, !0), Nt = n) : Nt = null, a && a !== Nt && v$1(a, r.swapClass, !1);
        }
    ...
    drop: function (t) {
      var e,
          ...
          u = s || this.sortable,
          d = this.options;
      Nt && v$1(Nt, d.swapClass, !1), Nt && (d.swap || s && s.options.swap) && c !== Nt && (u.captureAnimationState(), u !== l && l.captureAnimationState(), a = (n = Nt).parentNode, (r = (e = c).parentNode) && a && !r.isEqualNode(n) && !a.isEqualNode(e) && (o = C(e), i = C(n), r.isEqualNode(a) && o < i && i++, r.insertBefore(n, r.children[o]), a.insertBefore(e, a.children[i])), u.animateAll(), u !== l && l.animateAll());
    },
    nulling: function () {
      Nt = null;
    }
  ...
  function t(t) {
    ...
    t.options.supportPointer ? c$1(document, "pointerup", this._deselectMultiDrag) : (c$1(document, "mouseup", this._deselectMultiDrag), c$1(document, "touchend", this._deselectMultiDrag)), c$1(document, "keydown", this._checkKeyDown), c$1(document, "keyup", this._checkKeyUp), this.defaults = {
  ...
  return t.prototype = {
    ...
    setupClone: function (t) {
      ...
      if (this.isMultiDrag) {
        for (var o = 0; o < jt.length; o++) zt.push(A$1(jt[o])), zt[o].sortableIndex = jt[o].sortableIndex, zt[o].draggable = !1, zt[o].style["will-change"] = "", v$1(zt[o], this.options.selectedClass, !1), jt[o] === Lt && v$1(zt[o], this.options.chosenClass, !1);
    ...
    hideClone: function (t) {
      ...
      this.isMultiDrag && (zt.forEach(function (t) {
        m$1(t, "display", "none"), e.options.removeCloneOnHide && t.parentNode && t.parentNode.removeChild(t);
      }), n(), Wt = !0, o());
    },
    ...
    drop: function (t) {
      ...
      if (e) {
        var c = this.options,
            u = o.children;
        if (!qt) if (c.multiDragKey && !this.multiDragKeyDown && this._deselectMultiDrag(), v$1(Lt, c.selectedClass, !~jt.indexOf(Lt)), ~jt.indexOf(Lt)) jt.splice(jt.indexOf(Lt), 1), Ht = null, B({
          sortable: i,
          rootEl: n,
          name: "deselect",
          targetEl: Lt,
          ...
          if (jt.push(Lt), B({
            ...
            var d,
                ...
                f = C(Ht),
                p = C(Lt);
            if (~f && ~p && f !== p) for (p > f ? (h = f, d = p) : (h = p, d = f + 1); h < d; h++) ~jt.indexOf(u[h]) || (v$1(u[h], c.selectedClass, !0), jt.push(u[h]), B({
              sortable: i,
              rootEl: n,
              name: "select",
              targetEl: u[h],
        ...
        if (qt && this.isMultiDrag) {
          if ((o[k$1].options.sort || o !== n) && jt.length > 1) {
            var g = y$1(Lt),
    ...
    _deselectMultiDrag: function (t) {
      if (!(void 0 !== qt && qt || Ft !== this.sortable || t && f$1(t.target, this.options.draggable, this.sortable.el, !1) || t && 0 !== t.button)) for (; jt.length;) {
        var e = jt[0];
        v$1(e, this.options.selectedClass, !1), jt.shift(), B({
    ...
    utils: {
      select: function (t) {
        var e = t.parentNode[k$1];
        e && e.options.multiDrag && !~jt.indexOf(t) && (Ft && Ft !== e && (Ft.multiDrag._deselectMultiDrag(), Ft = e), v$1(t, e.options.selectedClass, !0), jt.push(t));
      },
      deselect: function (t) {
        var e = t.parentNode[k$1],
            n = jt.indexOf(t);
        e && e.options.multiDrag && ~n && (v$1(t, e.options.selectedClass, !1), jt.splice(n, 1));
      }
    },
    eventProperties: function () {
      var t = this,
...
var sortable_complete_esm = /*#__PURE__*/Object.freeze({
	__proto__: null,
	'default': It,
	Sortable: It
});

var require$$2 = /*@__PURE__*/getAugmentedNamespace(sortable_complete_esm);

var Sortable_1 = createCommonjsModule(function (module, exports) {
...
var _sortablejs = _interopRequireDefault(require$$2);
...
var Sortable = Sortable_1.default;

var lib = Sortable;

const FieldsPanel = ({ componentList }) => {
    return (React.createElement(lib, { options: {
            group: { name: 'item', pull: 'clone', put: false },
            sort: false,
        }, className: "panelWrapepr" }, componentList.map((item) => (React.createElement("div", { key: item.id, "data-id": item.id, "data-type": item.type, className: "formItemPanel" }, item.name)))));
};

const InputField = ({ value, onChange, config }) => {
    const { readOnly, placeholder } = config || {};
    return (React.createElement(Input, { style: { width: '100%' }, value: value, placeholder: placeholder }));
};
...
var OneToOneOutlined = {
  "icon": {
    ...
    "children": [{
      ...
      "tag": "path",
      "attrs": {
        "d": "M316 672h60c4.4 0 8-3.6 8-8V360c0-4.4-3.6-8-8-8h-60c-4.4 0-8 3.6-8 8v304c0 4.4 3.6 8 8 8zm196-50c22.1 0 40-17.9 40-39 0-23.1-17.9-41-40-41s-40 17.9-40 41c0 21.1 17.9 39 40 39zm0-140c22.1 0 40-17.9 40-39 0-23.1-17.9-41-40-41s-40 17.9-40 41c0 21.1 17.9 39 40 39z"
      }
    }, {
      "tag": "path",
      "attrs": {
...
var OneToOneOutlined$1 = function OneToOneOutlined$1(props, ref) {
...
OneToOneOutlined$1.displayName = 'OneToOneOutlined';
var OneToOneOutlined$2 = /*#__PURE__*/forwardRef(OneToOneOutlined$1);
...
const InputField$1 = {
    id: 10,
    name: '文本框',
    icon: React.createElement(OneToOneOutlined$2, null),
    type: 'InputField',
    fieldType: 'string',
    View: InputField,
    Config: {},
...
class ComponetStore {
    ...
    setComponent() {
        this.list = { ...this.list, TextField: InputField$1 };
    }
    getComponentList() {
        return [InputField$1];
    }
}
var ComponentStore = new ComponetStore();
...
const FormStateContext = createContext(initialValue);
...
const FormContent = () => {
    const { config, onChange } = useFormState();
    const handleOnAdd = (evt) => {
        const { clone: dragNode, newIndex } = evt;
        if (!newIndex)
            return;
        const dragNodeType = dragNode.dataset.type;
        const formConfigs = lodash.cloneDeep(config);
    ...
    const handleOnChange = (_, sortable, evt) => {
        if (evt.type === 'update') {
            handleOnUpdate(evt);
        }
        if (evt.type === 'add') {
    ...
    const handleOnChoose = (evt) => {
        console.log(evt, 'choose');
    };
    const renderSortableItem = () => {
        return lodash.map(config, (child) => {
            const Item = ComponentStore.getComponent(child.type).View;
            const { options } = child;
            return (React.createElement(Form.Item, { key: child.id, "data-id": child.id, "data-type": child.type, label: options.label, name: options.field, required: options.required },
                React.createElement(Item, null)));
        });
    };
    return (React.createElement(Form, { layout: "vertical" },
        React.createElement(lib, { options: {
                group: {
                    name: 'content',
                    pull: true,
                    put: true,
            ...
            }, onChange: handleOnChange }, renderSortableItem())));
};
...
const FormProvider = ({ children }) => {
    ...
    return (React.createElement(FormStateContext.Provider, { value: {
            config,
...
const FormEditor = () => {
    return (React.createElement(Layout, { className: "wrapper" },
        React.createElement(FormProvider, null,
            React.createElement(Layout.Sider, { theme: "light", width: 320, className: "sider" },
                React.createElement(FieldsPanel, { componentList: components })),
            React.createElement(Layout.Content, { className: "content" },
                React.createElement(FormContent, null)),
            React.createElement(Layout.Sider, { theme: "light", width: 400, className: "sider" },
                React.createElement(Config, null)))));
};

function PageEditor(props) {
    return (React.createElement("div", null, "\u8FD9\u662F\u4E00\u4E2APageEditor"));
}
...
const StartNodeConfiger = forwardRef((props, ref) => {
    ...
    return (React.createElement("div", null,
        React.createElement("p", null, "\u8FD9\u662F\u4E00\u4E2AStartNodeConfiger"),
        React.createElement("br", null),
        React.createElement(Form, { layout: "vertical", form: form, onValuesChange: onOptionsValuesChange },
            React.createElement(Form.Item, { name: "field1", label: "\u8BF7\u8F93\u5165\u7B2C\u4E00\u4E2A\u53C2\u6570", initialValue: options.field1 },
                React.createElement(Input.TextArea, { rows: 1 })),
            React.createElement(Form.Item, { name: "field2", label: "\u8BF7\u8F93\u5165\u7B2C\u4E8C\u4E2A\u53C2\u6570", initialValue: options.field2 },
...
function StartNodeViewer(props) {
    ...
    return (React.createElement("div", null,
        ...
        React.createElement("p", null,
            "\u7B2C\u4E00\u4E2A\u5B57\u6BB5\uFF1A",
            options.field1),
        React.createElement("p", null, "\u7B2C\u4E8C\u4E2A\u5B57\u6BB5\uFF1A")));
}
...
const InputNodeConfiger = forwardRef((props, ref) => {
    useImperativeHandle(ref, () => ({
        getOptions: () => {
            return { field2: 'xxx' };
        }
    ...
    return (React.createElement("div", null,
        React.createElement("p", null, "\u8FD9\u662F\u4E00\u4E2AInputNodeConfiger")));
});

function InputNodeViewer(props) {
    return (React.createElement("div", null,
        React.createElement("p", null, "\u8FD9\u662F\u4E00\u4E2AInputNodeViewer")));
}
...
const ApproveNodeConfiger = forwardRef((props, ref) => {
    useImperativeHandle(ref, () => ({
        getOptions: () => {
            return { fielda: 'xxx' };
        }
    ...
    return (React.createElement("div", null,
        React.createElement("p", null, "\u8FD9\u662F\u4E00\u4E2AApproveNodeConfiger")));
});

function ApproveNodeViewer(props) {
    return (React.createElement("div", null,
        React.createElement("p", null, "\u8FD9\u662F\u4E00\u4E2AApproveNodeViewer")));
}
...
const ConditionNodeConfiger = forwardRef((props, ref) => {
    useImperativeHandle(ref, () => ({
        getOptions: () => {
            return { fieldc: 'xxx' };
        }
    ...
    return (React.createElement("div", null,
        React.createElement("p", null, "\u8FD9\u662F\u4E00\u4E2AConditionNodeConfiger")));
});

function ConditionNodeViewer(props) {
    return (React.createElement("div", null,
        React.createElement("p", null, "\u8FD9\u662F\u4E00\u4E2AConditionNodeViewer")));
}
...
const ExclusiveBranchNodeConfiger = forwardRef((props, ref) => {
    useImperativeHandle(ref, () => ({
        getOptions: () => {
            return { fieldb: 'xxx' };
        }
    ...
    return (React.createElement("div", null,
        React.createElement("p", null, "\u8FD9\u662F\u4E00\u4E2ABranchNodeConfiger")));
});
...
function AppendNodeButton(props) {
    ...
    return (React.createElement("div", { className: "flow-node-addbtn", onClick: handleClick },
        React.createElement(PlusOutlined$2, null)));
}
...
function NodeList(props) {
    ...
    for (let nodeModel of startNodeModel) {
        ...
        let reactNode = (React.createElement("div", { key: nm.id, className: "flow-node" },
            React.createElement(NodeWrapper, Object.assign({}, props, { isBranch: isBranch, nodeModel: nm }))));
        reactNodes.push(reactNode);
    }
    return (React.createElement("div", { className: "flow-list" },
        children,
        reactNodes));
}
function NodeWrapper(props) {
    ...
    return (React.createElement(React.Fragment, null,
        props.isBranch ?
            React.createElement(NodeViewer, { key: nodeModel.id, dataModel: nodeModel }) :
            React.createElement("div", { className: "flow-node-item", onClick: onNodeItemClick },
                React.createElement("div", { className: "node-item-header", style: { backgroundColor: node.color } }, nodeModel.name),
                React.createElement("div", { className: "node-item-content" },
                    React.createElement(NodeViewer, { key: nodeModel.id, dataModel: nodeModel, options: nodeModel.options }))),
        editable && React.createElement(AppendNodeButton, { nodeModel: nodeModel })));
}

function ExclusiveBranchNodeViewer(props) {
    let branchs = props.dataModel.branchs;
    return (React.createElement("div", { className: "flow-branch" }, branchs && branchs.length > 0 &&
        branchs.map((startNodeModel, index) => {
            let clearBorder = null;
            if (index == 0) {
                clearBorder = React.createElement("div", { className: "clear-left-border" });
            }
            else if (index == branchs.length - 1) {
                clearBorder = React.createElement("div", { className: "clear-right-border" });
            }
            return React.createElement(NodeList, { startNodeModel: startNodeModel }, clearBorder);
        })));
}
...
const WorkflowEditorContext = createContext(contextInitValue);
...
function ConfigPanel(props) {
    ...
    if (!currentNode) {
        ...
        return (React.createElement(Drawer, { visible: isVisible, title: "Basic Drawer", placement: "right", closable: false, onClose: onClose, footer: footer(onClose, onSave) }, !!currentNode &&
            React.createElement(NodeConfiger, { options: currentNode.options, onOptionsValuesChange: onOptionsValuesChange })));
    }
}
function footer(onCancel, onSave) {
    return (React.createElement("div", { style: { textAlign: 'right' } },
        React.createElement(Button, { onClick: onCancel, style: { marginRight: 8 } }, "\u53D6\u6D88"),
        React.createElement(Button, { onClick: onSave, type: "primary" }, "\u63D0\u4EA4")));
}
...
function AppendNodeModal(props) {
    ...
    const appendNode = useCallback((node) => {
    ...
    return (React.createElement(Modal, { visible: isVisible, closable: false, onOk: handleOk, onCancel: handleCancel, footer: [] },
        React.createElement("div", { className: "node-append-selector" }, nodesSelector)));
}
function getNodesSelector(nodeMap, appendNode) {
    ...
    for (let key in nodeMap) {
        ...
        if (node.selectable) {
            reactNodes.push((React.createElement("div", { key: node.id, className: "node-card", onClick: () => appendNode(node) }, node.name)));
        }
    }
    return reactNodes;
}
...
function Flow(props) {
    ...
    return (React.createElement("div", { className: "flow" },
        React.createElement(NodeList, { startNodeModel: nodeModel }),
        React.createElement(EndNode, Object.assign({}, props))));
}
function EndNode(props) {
    return (React.createElement("div", { className: "flow-end" },
        React.createElement("section", { className: "workflowEndBox" },
            React.createElement("div", { className: "workflowEnd" }))));
}

function FlowCanvas(props) {
    return (React.createElement("div", { className: "workflow-editor-canvas" },
        React.createElement(Flow, null),
        React.createElement(AppendNodeModal, null)));
}
...
function WorkflowEditor(props) {
    ...
    const [nodeModel, setNodeModel] = useState(initNodeModel);
    const [peddingNode, setPeddingNode] = useState();
    ...
    return (React.createElement(WorkflowEditorContext.Provider, { value: contextValue },
        React.createElement("div", { className: "workflow-editor" },
...
export { FormEditor, PageEditor, PageRender, WorkflowEditor };
